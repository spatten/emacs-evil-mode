...
(defvar my-packages '(use-package evil navigate evil-collection projectile-rails org xclip rubocop ruby-mode flymake-ruby ruby-electric inf-ruby ruby-hash-syntax evil-surround markdown-mode move-text darkroom magit web-mode ag yaml-mode ripgrep lorem-ipsum haml-mode flycheck coffee-mode js2-mode exec-path-from-shell ruby-block evil-matchit vimish-fold))
