...
(defvar my-packages '(use-package evil color-theme-solarized navigate evil-collection projectile-rails org evil-org xclip rubocop ruby-mode flymake-ruby ruby-electric inf-ruby ruby-hash-syntax evil-surround markdown-mode move-text darkroom magit web-mode ag yaml-mode ripgrep lorem-ipsum haml-mode flycheck coffee-mode rjsx-mode exec-path-from-shell ruby-block evil-matchit vimish-fold systemd ruby-end rspec-mode graphql-mode))
